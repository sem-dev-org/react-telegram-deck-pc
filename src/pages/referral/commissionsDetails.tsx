...
import { getRewardGroupLogDetail } from '@/api/referral';
import { IReferralRewardsDetail } from '@/types/referral';
import { useCurrencyFormatter } from '@/hooks/useCurrencyFormatter';
import { useTranslation } from 'react-i18next';
import dayjs from 'dayjs';

export default function ReferralCommissionsDetailsPage() {
  ...
  useEffect(() => {
    setLoading(true);
    getRewardGroupLogDetail({ id: id, created_at: created_at }).then((res) => {
